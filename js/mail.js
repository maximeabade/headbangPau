...
function sendMail() {
    ...
    var message = document.getElementById("message").value+"\n\n\n" + genreContact + " " + firstNameContact + " " + nameContact + " né(e) le " + birthDateContact + " est " + roleBusiness + " et souhaite être contacté(e) à l'adresse suivante : " + emailContact + " le " + dateContact + ".\n" + "Cette personne a pour sujet : " + subject + ".\n" ;
